...
import { assignRecipeToSection, assignStockToSection, createSection, deleteSection, getSection, getSectionConsumption, getSectionInventory, getSectionRecipes, getSectionRecipesConsumption, getSections, recordConsumption, recordRecipeConsumption, removeSectionInventory, removeSectionRecipe, updateSection, updateSectionInventory } from "../controllers/sectionsController.js";
...
router.post("/:id/consume-recipe", recordRecipeConsumption);

router.get("/:id/recipes-consumption", getSectionRecipesConsumption);
