...
const Input = forwardRef<HTMLInputElement, InputProps>(({ label, error, helperText, leftIcon, rightIcon, className, onValueChange, ...props }, ref) => {
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="relative">
        ...
        <input ref={ref} className={inputClasses} aria-invalid={error ? "true" : "false"} aria-describedby={error ? `${props.id}-error` : helperText ? `${props.id}-helper` : undefined} {...props} onChange={handleChange} />
